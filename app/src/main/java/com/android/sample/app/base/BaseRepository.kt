...
abstract class BaseRepository<T>(
    ...
    protected abstract suspend fun query(id: Int?): T?

    protected abstract suspend fun fetch(id: Int?): T?

    protected abstract suspend fun saveFetchResult(t: T?)

    fun getResult(id: Int?): Flow<ViewState<T?>> = flow {
